...
extern LibraryDef libvoxels_moddef;
extern void Dtool_libvoxels_RegisterTypes();
extern void Dtool_libvoxels_ResolveExternals();
extern void Dtool_libvoxels_BuildInstants(PyObject *module);
...
PyObject *PyInit_voxels() {
  Dtool_libvoxels_RegisterTypes();
  Dtool_libvoxels_ResolveExternals();

  LibraryDef *defs[] = {&libvoxels_moddef, NULL};

  PyObject *module = Dtool_PyModuleInitHelper(defs, &py_voxels_module);
  if (module != NULL) {
    Dtool_libvoxels_BuildInstants(module);
  }
  return module;
}
